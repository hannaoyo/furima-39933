...
ActiveRecord::Schema[7.0].define(version: 2024_02_13_033959) do
  ...
  create_table "delivery_infos", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["order_id"], name: "index_purchase_infos_on_purchase_record_id"
  end
